...
const admins = [
  { name: "S. Kulkarni", email: "s.kulkarni@pvprotect.in", role: "Super Admin" },
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="card-shadow rounded-md border border-border bg-surface p-6">
          <p className="mb-4 font-mono text-[11px] uppercase tracking-widest text-lo">Admin accounts</p>
          <div className="space-y-3">
            {admins.map((a) => (
              <div key={a.email} className="flex items-center justify-between border border-border bg-surface2 px-4 py-3">
                <div>
        ...
        <div className="card-shadow rounded-md border border-border bg-surface p-6">
          <p className="mb-4 font-mono text-[11px] uppercase tracking-widest text-lo">Platform preferences</p>
          <div className="space-y-4 text-[13px]">
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              <span className="text-lo">Auto-reassign on technician rejection</span>
              <span className="font-mono text-teal">Enabled</span>
            </div>
            <div className="flex items-center justify-between border-b border-border pb-3">
